...
class CustomUserManager(BaseUserManager):
    ...
    Extends Django's BaseUserManager to create users with email-based
    authentication. The username field is retained for compatibility but
    is automatically populated with the email if not provided.
    
    Attributes:
        use_in_migrations: True to allow use in migration files.
    """
